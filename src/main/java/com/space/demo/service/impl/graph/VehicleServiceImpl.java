...
import com.space.demo.dao.graph.VehicleDao;
...
import com.space.demo.service.graph.VehicleService;
...
public class VehicleServiceImpl implements VehicleService {
    ...
    @Override
    public List<Vehicle> getNodesByName(String name) {
        String tmp = ".*"+name+".*";
        return dao.getNodesByBlurName(tmp);
    }

    @Override
    public Vehicle getNodeByName(String name) {
